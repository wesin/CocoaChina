        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), { [weak self] () -> Void in
            ...
            */
            if iCloudRootPath != nil {
                let iCloudLogsPath = iCloudRootPath!.URLByAppendingPathComponent(self!.icloudData!.iCloudLogsDirectory)
                let iCloudDataPath = iCloudRootPath!.URLByAppendingPathComponent(self!.icloudData!.iCloudDataDirectoryName)
                ...
                let path = iCloudRootPath?.URLByAppendingPathComponent((self?.icloudData?.iCloudDataDirectoryName)!).URLByAppendingPathComponent((self?.databasePath?.lastPathComponent)!)
