...
extension UIImage {
    ...
    static func animatedImageWithData(data: NSData) -> UIImage? {
    ...
    static func delayForImageAtIndex(index: Int, source: CGImageSourceRef)
        -> Double {
            var delay = 0.1
    ...
    static func gcdForPair(var a: Int?, var _ b: Int?) -> Int {
    ...
    static func animatedImageWithSource(source: CGImageSource) -> UIImage? {
        ...
        for i in 0..<count {
            ...
            // At it's delay in cs
            var delaySeconds = UIImage.delayForImageAtIndex(i,
                source: source)
